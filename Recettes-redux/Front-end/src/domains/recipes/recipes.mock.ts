...
export const recipeMock = recipeStateMock.recipes[0]
export const
    {
        title : recipeTitleMock,
        image : recipeImageMock,
        id : recipeIdMock,
        ingredients : recipeIngredientsMock,
        preparationTime : recipePreparationTimeMock,
        cookingTime : recipeCookingTimeMock,
        calories : recipeCaloriesMock,
        description: recipeDescriptionMock
    } = recipeStateMock.recipes[1]
